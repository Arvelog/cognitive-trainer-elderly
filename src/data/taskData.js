...
export const ANTONYM_DATA = [
  {
    sentences: [
      { s: 'Чай гарячий, а лід холодний', a: 'холодний' },
      { s: 'Слон великий, а мишка маленька', a: 'маленька' },
      { s: 'Вдень світло, а вночі темно', a: 'темно' },
      { s: 'Дорога далека, а дім близький', a: 'близький' },
    ],
  },
  {
    sentences: [
      ...
      { s: 'Гаманець повний, а кишеня порожня', a: 'порожня' },
  ...
  },
  {
    sentences: [
      ...
      { s: 'Пакунок довгий, а олівець короткий', a: 'короткий' },
      { s: 'Біг швидкий, а крок повільний', a: 'повільний' },
    ],
  },
  {
    sentences: [

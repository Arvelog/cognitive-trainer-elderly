export const FIND_ODD_DATA = [
  { cat: 'Город', items: ['🥕 Морква', '🥒 Огірок', '🍅 Помідор', '🥬 Капуста', '🔧 Гайковий ключ'], odd: 4 },
  { cat: 'Кухня', items: ['🍳 Сковорода', '🥄 Ложка', '🍽️ Тарілка', '🥘 Каструля', '🔨 Молоток'], odd: 4 },
  { cat: 'Аптечка', items: ['💊 Таблетки', '🩹 Пластир', '🌡️ Термометр', '🧴 Мазь', '🎸 Гітара'], odd: 4 },
  { cat: 'Одяг', items: ['👕 Сорочка', '👖 Штани', '🧣 Шарф', '🧦 Шкарпетки', '🔑 Ключі'], odd: 4 },
  { cat: 'Фрукти', items: ['🍎 Яблуко', '🍌 Банан', '🍊 Апельсин', '🍐 Груша', '🧲 Магніт'], odd: 4 },
  { cat: 'Інструменти', items: ['🔨 Молоток', '🪛 Викрутка', '🔧 Ключ', '🪚 Пилка', '🍕 Піца'], odd: 4 },
];

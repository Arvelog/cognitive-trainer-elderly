...
{
  "matchWord": { "word": "простий предмет або річ", "options": ["дія1", "дія2", "дія3", "дія4"], "correct": 0 },
...
- "matchWord.word" — коротке, дуже просте слово-предмет або річ
- "matchWord.options" — рівно 4 прості дії або спосіб використання цього слова
- "matchWord.options" НЕ МОЖУТЬ повторювати саме слово-підказку
- "matchWord.correct" — індекс правильної відповіді (0-3)
- Краще робити відповідь як просту дію: "читати", "мити", "відчиняти", "поливати", "їсти", "прасувати"
- Не роби варіанти занадто схожими між собою; тільки одна дія має підходити логічно

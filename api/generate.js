...
- Для "antonyms" речення ПОВИННІ мати життєвий та логічний сенс (наприклад: "Чай гарячий, а лід... [холодний]"). КАТЕГОРИЧНО НЕ генеруй абсурдні або нелогічні твердження (наприклад, "старі речі стають новими", "після смерті буде життя" тощо). Тільки реальні факти.

...
{
  "matchWord": { "word": "просте слово-підказка", "options": ["варіант1", "варіант2", "варіант3", "варіант4"], "correct": 0 },
...
- "matchWord.word" — коротке, дуже просте слово
- "matchWord.options" — рівно 4 прості варіанти, тільки один справді підходить до слова
- "matchWord.options" НЕ МОЖУТЬ повторювати саме слово-підказку; не роби правильну відповідь тим самим словом
- "matchWord.correct" — індекс правильної відповіді (0-3)
- Краще робити відповідь як дію, предмет або пов'язане поняття, а не буквальне повторення слова-підказки

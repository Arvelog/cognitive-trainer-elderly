...
Точна структура (додержуйся типів!):
{
  ...
  "categories": { "groupLabels": ["Кухня", "Двір", "Аптека"], "items": [{"text":"ложка","group":0}, {"text":"лопата","group":1}, {"text":"пластир","group":2}, {"text":"чашка","group":0}, {"text":"граблі","group":1}, {"text":"сироп","group":2}] },
...
- Для "categories" роби 6 предметів і 3 чіткі групи, наприклад ["Кухня", "Двір", "Аптека"]. Кожен предмет має поле "group" з індексом 0, 1 або 2; у кожній групі має бути по 2 предмети

...
{
  "findOdd": { "cat": "назва категорії", "items": ["emoji предмет1", "emoji предмет2", "emoji предмет3", "emoji предмет4", "emoji НЕвідповідний"], "odd": 4 },
...
- "findOdd.items" — ПОВИННО БУТИ РІВНО 5 ЕЛЕМЕНТІВ (масив з 5 рядків)
- "odd" — це індекс зайвого (0-4), зайвий завжди має бути з іншої категорії

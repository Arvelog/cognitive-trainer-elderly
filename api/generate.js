...
Точна структура (додержуйся типів!):
{
  ...
  "verbs": { "obj": "emoji Хто/Що", "correct": ["Правильне1", "Правильне2", "Правильне3"], "wrong": ["Невірно1", "Невірно2", "Невірно3"], "context": "Що може робити...?", "scene": "Short English description of a scene for image generation, e.g. A cheerful cook preparing soup in a cozy kitchen" }
}
...
- Для "verbs.scene": напиши КОРОТКИЙ опис сцени АНГЛІЙСЬКОЮ мовою для генерації картинки. Сцена має показувати персонажа/об'єкт за характерною діяльністю. Стиль: дружній, позитивний, мультяшний. Приклад: "A cheerful cook preparing soup in a cozy bright kitchen"

...
- "matchWord.word" — коротка, дуже проста дія ТІЛЬКИ з цього списку: "Прання", "Читання", "Риболовля", "Чай", "Шиття", "Прибирання", "Поливання", "Ремонт", "Сніданок", "Посадка"
- "matchWord.options" — рівно 5 простих предметів: 2 реально потрібні для цієї дії та 3 очевидно зайві
...
- Не використовуй неоднозначні дії або процеси: "квасити", "готувати", "робити", "їсти", "пити", "купувати"

...
Точна структура (додержуйся типів!):
{
  ...
  "categories": { "leftLabel": "Кухня", "rightLabel": "Сад", "items": [{"text":"ложка","group":"left"}, {"text":"лійка","group":"right"}, {"text":"чашка","group":"left"}, {"text":"лопата","group":"right"}, {"text":"каструля","group":"left"}, {"text":"граблі","group":"right"}] },
...
- Для "categories" роби 6 предметів і 2 чіткі групи, наприклад "Кухня" / "Сад" або "Дім" / "Двір". Кожен предмет має поле "group": "left" або "right"
